 ...
 recognition.onend = () =>setIsListening(false)
  ...
  const handleVoiceCommand = async (command) =>{
    ...
    if (command.includes("what is your name")) {
      const response =
        "Hello, I'm your personal AI assistant, My name is Nova";
      speakText(response);
      setInformation(response);
      return;
    } else if (command.includes("hello nova")) {
      const response = "Hello Sir I'm Nova, your personal voice assistant, How can i help you?";
      speakText(response);
      setInformation(response);
      return;
    } else if (command.includes("what is your age")) {
      const response = "Hello Sir I'm Nova, I'm 2 day old";
      speakText(response);
      setInformation(response);
      return;
    }
